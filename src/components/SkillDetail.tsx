...
import { Skill, InstallMethod } from "../types/skill";
...
export function SkillDetail({ skill, installMethod, onClose, onInstallChange }: SkillDetailProps) {
          ...
          {!skill.isFetched ? (
            <div className="text-center py-12">
              <p className="text-gray-500 dark:text-gray-400 mb-4">
                This skill hasn't been fetched yet.
              </p>
              <button
                onClick={handleFetch}
                disabled={fetching}
